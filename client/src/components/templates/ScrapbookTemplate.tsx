...
import styles from './ScrapbookTemplate.module.css';

// A playful, intentionally-imperfect "handmade collage" layout: a rotated
// Polaroid-style photo frame, washi-tape corner decorations, and each
// section block tilted a degree or two off-axis. Only frames/decorations/
// headings rotate — body copy stays level so it remains easy to read.
export default function ScrapbookTemplate({ data }: ResumeTemplateProps) {
