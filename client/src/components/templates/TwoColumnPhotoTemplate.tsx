...
import styles from './TwoColumnPhotoTemplate.module.css';

// Narrow neutral-gray left column (photo/contacts/skills), wide right
// column for the career narrative — a light, airy two-column read.
export default function TwoColumnPhotoTemplate({ data }: ResumeTemplateProps) {
