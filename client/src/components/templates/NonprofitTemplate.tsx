...
import styles from './NonprofitTemplate.module.css';

// Warm, mission-driven tone: earthy accent palette, the "why" (summary,
// framed as impact) leads before the career details.
export default function NonprofitTemplate({ data }: ResumeTemplateProps) {
