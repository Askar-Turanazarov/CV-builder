...
// Senior-leadership style: large serif name, a single navy rule, generous
// whitespace throughout. No photo emphasis — the tone is authority, not warmth.
export default function ExecutiveTemplate({ data }: ResumeTemplateProps) {
