...
import styles from './ElegantSerifTemplate.module.css';

// A refined, delicate serif treatment — soft off-white paper feel, thin
// hairline dividers, italic accents. Understated elegance over boldness.
export default function ElegantSerifTemplate({ data }: ResumeTemplateProps) {
