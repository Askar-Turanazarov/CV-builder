...
import styles from './DarkSidebarTemplate.module.css';

// Unlike the existing Sidebar template (which follows the chosen theme +
// light/dark toggle), this sidebar is ALWAYS a fixed dark charcoal panel —
// a permanent design choice, not a color-mode reaction. The theme's accent
// color is still used for highlights, but the panel itself never lightens.
export default function DarkSidebarTemplate({ data }: ResumeTemplateProps) {
