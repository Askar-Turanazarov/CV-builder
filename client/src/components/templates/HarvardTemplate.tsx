...
import styles from './HarvardTemplate.module.css';

// Harvard/Ivy League style: the classic MBA-career-center format. No photo,
// no icons — just clean serif typography and small-caps headers. The most
// conservative, most ATS-safe template in the set, but the accent color and
// skill/language pills still tie it into the active theme.
export default function HarvardTemplate({ data }: ResumeTemplateProps) {
    ...
    <div className={`${styles.page} resume-document`}>
      <header className={styles.header}>
        ...
        {data.personalInfo.birthDate && (
          <p className={styles.contactLine}>{formatFullDate(data.personalInfo.birthDate, data.uiLanguage)}</p>
        )}
      </header>
