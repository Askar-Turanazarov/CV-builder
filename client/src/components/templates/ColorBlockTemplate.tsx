...
import styles from './ColorBlockTemplate.module.css';

// Bold geometric identity: a solid accent-color block behind the header,
// square (not round) bullets and dividers throughout.
export default function ColorBlockTemplate({ data }: ResumeTemplateProps) {
