...
import styles from './PhotoPortraitTemplate.module.css';

// Editorial/magazine-cover feel: a full-width photo banner with the name
// overlaid directly on it, like a feature-story masthead.
export default function PhotoPortraitTemplate({ data }: ResumeTemplateProps) {
    ...
    <div className={`${styles.page} resume-document`}>
      <header className={styles.banner}>
        {data.personalInfo.photo && (
          <img className={`${styles.photo} resume-photo`} src={data.personalInfo.photo} alt={data.personalInfo.fullName} />
        )}
      ...
      <div className={styles.body}>
        <div className={styles.contactLine}>
          <ContactLinks contacts={data.contacts} variant={data.viewMode === 'site' ? 'buttons' : 'plain'} className={styles.contactLinks} />
