...
// Clinical/healthcare tone: crisp white-and-blue palette, checklist-style
// bullets, calm and highly structured — trust and precision over flair.
export default function HealthcareTemplate({ data }: ResumeTemplateProps) {
