...
// Dynamic, non-rectangular identity: a diagonal accent-color slice cuts
// across the header/photo area via clip-path, breaking the usual grid.
export default function DiagonalTemplate({ data }: ResumeTemplateProps) {
  ...
  return (
    <div className={`${styles.page} resume-document`}>
      <header className={styles.header}>
        <div className={styles.diagonalFill} />
