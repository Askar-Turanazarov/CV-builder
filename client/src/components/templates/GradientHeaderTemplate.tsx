...
import styles from './GradientHeaderTemplate.module.css';

// Modern web-app aesthetic: a colored gradient banner behind name/photo,
// clean single-column body below. The banner's bottom edge is an organic
// wave (clip-path), not a flat rectangle, so its silhouette reads clearly
// different from a flat color-block header.
export default function GradientHeaderTemplate({ data }: ResumeTemplateProps) {
